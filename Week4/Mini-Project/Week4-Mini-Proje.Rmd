...
```{r}
havaK<-havaK[-1,]
havaK$`İstanbul - Tuzla` <- gsub(",","\\.",havaK$`İstanbul - Tuzla`)
havaK$...3 <- gsub(",","\\.",havaK$...3)
havaK$...4 <- gsub(",","\\.",havaK$...4)
havaK$...5 <- gsub(",","\\.",havaK$...5)
havaK$...6 <- gsub(",","\\.",havaK$...6)
havaK$...7 <- gsub(",","\\.",havaK$...7)
havaK$...8 <- gsub(",","\\.",havaK$...8)
havaK$...9 <- gsub(",","\\.",havaK$...9)

havaK$`İstanbul - Tuzla`<- as.numeric(havaK$`İstanbul - Tuzla`)
havaK$...3<- as.numeric(havaK$...3)
havaK$...4<- as.numeric(havaK$...4)
havaK$...5<- as.numeric(havaK$...5)
havaK$...6<- as.numeric(havaK$...6)
havaK$...7<- as.numeric(havaK$...7)
havaK$...8<- as.numeric(havaK$...8)
havaK$...9<- as.numeric(havaK$...9)
...
```{r}
library(dygraphs)
dygraph(havaK[, c("Time", "İstanbul - Tuzla", "...3")], x = "Time") %>% 
  dyAxis("y", label = "PM10") %>% 
  dyAxis("y2", label = "PM2.5", independentTicks = TRUE) %>% 
  dySeries("İstanbul - Tuzla", label = "PM10", axis = "y") %>% 
  dySeries("...3", label = "PM2.5", axis = "y2") %>% 
  dyRangeSelector()
